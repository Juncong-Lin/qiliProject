...
URL_TEMPLATE = "https://www.sign-in-global.com/product/index.php?page={page_num}&act=shopping_history&productid=12389"
TOTAL_PAGES = 72
HEADERS = {
...
def add_bar_chart(worksheet, title, position, cat_col, data_col, min_row, max_row, num_categories):
    chart = BarChart()
    chart.style = 2  # Set default style to match the provided chart
